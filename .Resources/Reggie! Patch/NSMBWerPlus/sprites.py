...
class SpriteImage_Grrrol(SLib.SpriteImage_StaticMultiple):  # 536
    def __init__(self, parent):
        super().__init__(
            parent,
            1.5,
...
class SpriteImage_GrrrolSpawner(SLib.SpriteImage_StaticMultiple):  # 537
    def __init__(self, parent):
        super().__init__(parent, 1.5)
...
ImageClasses = {
    ...
    536: SpriteImage_Grrrol,
    537: SpriteImage_GrrrolSpawner,
}
